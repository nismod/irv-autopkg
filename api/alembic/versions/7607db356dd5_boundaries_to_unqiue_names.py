...
def upgrade() -> None:
    ...
    op.alter_column("boundaries", "name", existing_type=sa.VARCHAR(), nullable=False)
    op.alter_column(
        "boundaries", "name_long", existing_type=sa.VARCHAR(), nullable=False
    )
    op.alter_column(
        "boundaries", "admin_level", existing_type=sa.VARCHAR(), nullable=False
    )
    op.alter_column(
        "boundaries",
        "geometry",
    ...
    op.create_index(
        op.f("ix_boundaries_name_long"), "boundaries", ["name_long"], unique=True
    )
...
def downgrade() -> None:
    ...
    op.create_index(
        "ix_boundaries_name_long", "boundaries", ["name_long"], unique=False
    )
    ...
    op.alter_column(
        "boundaries", "admin_level", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column(
        "boundaries", "name_long", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column("boundaries", "name", existing_type=sa.VARCHAR(), nullable=True)
    # ### end Alembic commands ###
