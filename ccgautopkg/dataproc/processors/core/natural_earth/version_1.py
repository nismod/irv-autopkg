...
class Processor(BaseProcessorABC):
    ...
    def generate(self):
        ...
        crop_success = self.processing_backend.crop_raster(
            geotiff_fpath, output_fpath, self.boundary
        )
    ...
    def _fetch_source(self) -> str:
        ...
        expected_source_path = self.processing_backend.build_absolute_path(
            "natural_earth", "NE2_50M_SR", "NE2_50M_SR.tif"
        )
    ...
    def _fetch_zip(self) -> str:
        ...
        zip_path = self.processing_backend.download_file(
            self.source_zip_url, "natural_earth/NE2_50M_SR.zip"
        )
        return zip_path
