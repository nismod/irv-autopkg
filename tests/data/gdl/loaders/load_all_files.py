...
from api.db.models import DevelopmentAnnual
...
def load_all_data():
    ...
    with Session() as session:
        session.query(DevelopmentAnnual).delete()
        session.query(IncomeAnnual).delete()
        session.query(HealthcareAnnual).delete()
        session.query(EducationAnnual).delete()
