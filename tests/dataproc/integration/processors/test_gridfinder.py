...
TEST_DATA_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))), "data", "gridfinder")
    ...
    def test_generate(self):
        ...
        for _file in os.scandir(TEST_DATA_DIR):
            shutil.copy(
                ...
                os.path.join(_file.name, self.proc.source_folder)
            )
